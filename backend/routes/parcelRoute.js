...
/**
 * @swagger
 * /api/parcels/customer:
 *   post:
 *     summary: Create a parcel as a customer
 *     description: Creates a new parcel belonging to the currently authenticated customer.
 *     tags: [Parcels]
 *     security:
 *       - bearerAuth: []
 */
...
/**
 * @swagger
 * /api/parcels/my-shipments:
 *   get:
 *     summary: Get customer's shipments
 *     description: Returns only the shipments belonging to the authenticated customer.
 *     tags: [Parcels]
 *     security:
 *       - bearerAuth: []
 */
...
/**
 * @swagger
 * /api/parcels/my-shipments/{id}:
 *   get:
 *     summary: Get customer's shipment by ID
 *     description: Returns a shipment only if it belongs to the authenticated customer.
 *     tags: [Parcels]
 *     security:
 *       - bearerAuth: []
 */
 ...
 *   post:
 *     summary: Create a new parcel (admin)
 *     description: Creates a parcel for a selected customer.
 *     tags: [Parcels]
 *     security:
 *       - bearerAuth: []
 */
 ...
 *   get:
 *     summary: Get all parcels (admin only)
 *     description: Retrieve all parcels with pagination, filtering, and search.
 *     tags: [Parcels]
 *     security:
 *       - bearerAuth: []
 */
 ...
 *   get:
 *     summary: Get parcel by tracking number
 *     description: Retrieves a parcel using its unique tracking number.
 *     tags: [Parcels]
 *     security:
 *       - bearerAuth: []
 */
 ...
 * /api/parcels/{id}:
 *   get:
 *     summary: Get parcel by ID (admin)
 *     tags: [Parcels]
 *     security:
 *       - bearerAuth: []
 */
 ...
 *     description: Updates parcel tracking information. Admin only.
 *     tags: [Parcels]
 *     security:
 *       - bearerAuth: []
 */
