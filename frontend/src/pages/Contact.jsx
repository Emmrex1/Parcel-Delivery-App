...
const contactInfo = [
  { icon: MapPin, label: 'Address', value: 'No 3 Logistics Hub, Main Alakia, Ibadan, Nigeria' },
  { icon: Phone, label: 'Phone', value: '+234 9161325404' },
  { icon: Mail, label: 'Email', value: 'oyewooyewale94@gmail.com' },
];
